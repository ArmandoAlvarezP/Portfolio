...
export const Footer = () => {
  return (
    <footer className="p-10">
        <nav className="container mx-auto flex flex-row justify-end items-center gap-5">
            <Link to="https://github.com/ArmandoAlvarezP?tab=repositories" target="_blank">
            ...
            <Link to="https://www.linkedin.com/in/armando-alvarez-p%C3%A9rez-03843ab5/" target="_blank">
